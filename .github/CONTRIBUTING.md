...
5. In rare cases, we might decide that a PR should be closed. We'll make sure to
...
It can be time-consuming to get a PR merged. It can be frustrating to deal with
